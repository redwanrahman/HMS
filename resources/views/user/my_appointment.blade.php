...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +880 123 4567891 </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{url('/')}}"><span class="text-primary">Health</span>-Hospital</a>
  ...
  <div align="center" style="padding:70px; ">
      <table>
          ...
          <tr style="background-color: black"; align="center">
              ...
              <td><a class="btn btn-danger" onclick="return confirm('Are yoy sure to delete this')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
          </tr>
